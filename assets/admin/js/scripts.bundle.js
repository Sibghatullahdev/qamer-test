var mApp = function() {
    var e = function() {
            $('[data-toggle="m-tooltip"]').each(function() {
                var e = $(this),
                    t = e.data("skin") ? "m-tooltip--skin-" + e.data("skin") : "";
                e.tooltip({
        ...
        t = function() {
            $('[data-toggle="m-popover"]').each(function() {
                var e = $(this),
                    t = e.data("skin") ? "m-popover--skin-" + e.data("skin") : "";
                e.popover({
                ...
                var n = {
                        ...
                        var r = {
                            ...
                            populate: function() {
                                ...
                                e.each(o.getOption("toolbar.items.pagination.pageSizeSelect"), function(t, a) {
                                    var n = a; - 1 === a && (n = "All"), e("<option/>").attr("value", a).html(n).appendTo(d)
                                }), e(a).ready(function() {
                    ...
                    updateRawData: function() {
                        ...
                        return "undefined" === e.type(a.fullJsonData) && (a.fullJsonData = a.jsonData), a.jsonData = e(a.fullJsonData).sort(function(e, a) {
                            ...
                            for (var n in a)
                                if (a.hasOwnProperty(n) && "string" === e.type(a[n]) && a[n].toLowerCase().indexOf(t.query.generalSearch) > -1) return !0;
                            return !1
...
// $(document).ready(function() {
//     // $('#m_topbar_notification_icon-d').on('click', function(e){
//     //     e.preventDefault();
...
function readNotification_d(){
    console.log(notification_route_d);
    alert("Notification Clicked");
    $.ajax({
        type: "get",
        url: notification_route_d,
        // data: ,
        cache: false,
